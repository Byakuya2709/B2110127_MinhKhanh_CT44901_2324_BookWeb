    ...
    <div class="flex justify-center items-center h-full">
      <div class="flex max-w-4xl mt-20">
        <div class="bg-white p-8 w-full ">
          ...
          <form @submit.prevent="newPublisher">
            <div class="my-3">
  ...
  methods: {
    ...
    async newPublisher() {
      try {
        ...
        const response = await api.post(`/manager/publisher/new`,publisherData);
    ...
    validatePublisherName(value) {
      this.validated['publisherName'] =  this.validated.publisherName = value.length >= 6;
    },
